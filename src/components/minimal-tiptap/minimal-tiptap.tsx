...
const Toolbar = ({ editor }: { editor: Editor }) => (
  <div className="shrink-0 overflow-x-auto border-b border-border p-2">
    <div className="flex w-max items-center gap-px">
      ...
      <SectionTwo
        editor={editor}
        activeActions={['leftAlign', 'centerAlign', 'rightAlign', 'justifyAlign']}
        mainActionCount={4}
      />
...
export const MinimalTiptapEditor = React.forwardRef<HTMLDivElement, MinimalTiptapProps>(
  ({ value, onChange, className, editorContentClassName, editable = true, ...props }, ref) => {
    ...
    return (
      <MeasuredContainer
        ...
        ref={ref}
        className={cn(
          editable && "rounded-md border border-input shadow-sm focus-within:border-primary",
